/* eslint-disable no-template-curly-in-string, @typescript-eslint/no-require-imports */
...
import mainnets from './packages/base/networks/mainnets.json'
import testnets from './packages/base/networks/testnets.json'
